...
const apiUrl =
  ...
  "http://127.0.0.1:8010/api/perfumes/live?retailer_slugs=life-pharmacy&retailer_slugs=chemist-warehouse-nz&retailer_slugs=healthpost&retailer_slugs=the-warehouse&limit_per_retailer=200";
