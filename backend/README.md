...
- Lush NZ: official NZ storefront product search endpoint.
...
Run a perfume-only scrape across Life Pharmacy, Chemist Warehouse NZ, and Lush with duplicate products merged by brand/name/size:
